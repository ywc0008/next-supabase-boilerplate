...
const features = [
  ...
  },
  {
    ...
    content:
      "An open source boilerplate that anyone can freely use and extend.",
  },
  {
    ...
    <div className="flex flex-col items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="w-full max-w-7xl text-center space-y-4 mt-8">
        <div className="h-4">
          <TypingAnimation className="text-lg text-muted-foreground">
            {user
              ...
              : "Easily build web applications with Next.js and Supabase"}
          </TypingAnimation>
        </div>
        <h1 className="text-5xl font-bold tracking-tight sm:text-6xl mt-6">
          <AuroraText className="text-6xl sm:text-7xl font-extrabold">
            Next.js + Supabase
          </AuroraText>
        </h1>
        <p className="mt-6 text-lg leading-8 text-muted-foreground max-w-2xl mx-auto">
          Quickly prototype and deploy with modern web development stack. A
          boilerplate with integrated authentication system and database.
        </p>
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <Link
            href="https://github.com/ywc0008/next-supabase-boilerplate"
            target="_blank"
          >
  ...
  return (
    <Card className="w-[400px] h-[280px] mx-4 flex flex-col">
      ...
      <CardContent className="flex-grow">
        <p className="text-sm break-words overflow-hidden overflow-ellipsis line-clamp-5">
          {content}
        </p>
      </CardContent>
    </Card>
